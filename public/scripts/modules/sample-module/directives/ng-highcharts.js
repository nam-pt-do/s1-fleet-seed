/*global define */
define(['angular', 'services-module','directives-module'], function (angular, services, directives) {
    'use strict';

    /* Directives  */
    services.factory('highchartsUtils', highchartsUtils);

    directives.directive('highchart', [
        'highchartsUtils',
        highchart
    ]);
});
...
function highchart(highchartsUtils) {
    ...
    var getMergedOptions = function (scope, element, config) {
        ...
        if (config.options) {
            mergedOptions = highchartsUtils.deepExtend(defaultOptions, config.options);
        } else {
        ...
        angular.forEach(axisNames, function (axisName) {
            if (angular.isDefined(config[axisName])) {
                ...
                if (angular.isDefined(config[axisName].currentMin) || angular.isDefined(config[axisName].currentMax)) {
                    highchartsUtils.prependMethod(mergedOptions.chart.events, 'selection', function (e) {
                        var thisChart = this;
                        if (e[axisName]) {
                    ...
                    highchartsUtils.prependMethod(mergedOptions.chart.events, 'addSeries', function (e) {
        ...
        link: function (scope, element, attrs) {
            ...
            var processSeries = function (series) {
                ...
                for (i = chart.series.length - 1; i >= 0; i--) {
                    ...
                    if (s.options.id !== 'highcharts-navigator-series' && highchartsUtils.indexOf(ids, s.options.id) < 0) {
                        s.remove(false);
                    }
                }
                return true;
